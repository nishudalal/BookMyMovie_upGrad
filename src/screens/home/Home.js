...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(this.props.baseUrl + "movies?status=PUBLISHED")
    ...
    // Released movies
    axios
      .get(this.props.baseUrl + "movies?status=RELEASED")
      .then(function (response) {
        // handle success
        that.setState({
          releasedMovies: response.data.movies,
        });
      })
      .catch(function (error) {
        // handle error
    ...
    // Get artists
    axios
      .get(this.props.baseUrl + "artists")
      .then(function (response) {
        // handle success
        that.setState({
  ...
  filterApplyHandler = () => {
    ...
    axios
      .get(this.props.baseUrl + "movies" + encodeURI(queryString))
      .then(function (response) {
        // handle success
        that.setState({
          releasedMovies: response.data.movies,
